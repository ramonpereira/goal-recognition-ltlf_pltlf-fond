...
(define (problem triangle-tire-p04)
  ...
  (:init 
      (vehicleat l17)
      (road l11 l12) (road l12 l13) (road l12 l11)
      ...
      (road l21 l12) (road l22 l13) (road l22 l12)
      (road l22 l32) (road l22 l23)
      (road l23 l14) (road l24 l15) 
      (road l25 l16) (road l26 l17) (road l17 l26)
