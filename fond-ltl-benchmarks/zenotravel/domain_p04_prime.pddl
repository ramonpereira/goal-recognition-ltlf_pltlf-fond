(define (domain zenotravel)
	...
	(:action trans-0
		:parameters (?p01 - person ?c86 - city ?p40 - person ?c44 - city)
		:precondition (and (or (and (q1 ?p01 ?c86 ?p40 ?c44) (not (atperson ?p01 ?c86))) (and (q1 ?p01 ?c86 ?p40 ?c44) (atperson ?p01 ?c86) (not (atperson ?p40 ?c44))) (and (q2 ?p01 ?c86 ?p40 ?c44) (not (atperson ?p01 ?c86))) (and (q2 ?p01 ?c86 ?p40 ?c44) (atperson ?p01 ?c86) (not (atperson ?p40 ?c44)))) (not (turnDomain)))
		:effect (and (q2 ?p01 ?c86 ?p40 ?c44) (not (q3 ?p01 ?c86 ?p40 ?c44)) (not (q1 ?p01 ?c86 ?p40 ?c44)) (turnDomain))
	)
	(:action trans-1
		:parameters (?p01 - person ?c86 - city ?p40 - person ?c44 - city)
		:precondition (and (or (and (q1 ?p01 ?c86 ?p40 ?c44) (atperson ?p01 ?c86) (atperson ?p40 ?c44)) (and (q2 ?p01 ?c86 ?p40 ?c44) (atperson ?p01 ?c86) (atperson ?p40 ?c44)) (q3 ?p01 ?c86 ?p40 ?c44)) (not (turnDomain)))
		:effect (and (q3 ?p01 ?c86 ?p40 ?c44) (not (q2 ?p01 ?c86 ?p40 ?c44)) (not (q1 ?p01 ?c86 ?p40 ?c44)) (turnDomain))
	)
)